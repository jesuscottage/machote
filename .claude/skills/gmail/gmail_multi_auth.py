...
Usage:
    python3 execution/gmail_multi_auth.py --account yourwork
    python3 execution/gmail_multi_auth.py --account youraccount
...
CREDENTIALS_MAP = {
    "yourwork": str(_CONFIG_DIR / "credentials_yourwork.json"),
    "youraccount": str(_CONFIG_DIR / "credentials.json"),
    "personal": str(_CONFIG_DIR / "credentials.json"),
}
...
def get_token_file(account_name: str) -> str:
    ...
    return str(_CONFIG_DIR / f"token_{account_name}.json")
...
Examples:
  Authorize an account:
    python3 execution/gmail_multi_auth.py --account yourwork
    python3 execution/gmail_multi_auth.py --account youraccount --email your-email@example.com
